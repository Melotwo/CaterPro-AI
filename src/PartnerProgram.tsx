      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {[
            ...
            <div key={index} className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] relative overflow-hidden group hover:scale-[1.02] transition-all duration-300 border border-slate-200 dark:border-slate-800">
              <div className="relative z-10">
                <div className="mb-6 p-4 bg-slate-50 dark:bg-slate-800 rounded-2xl w-fit shadow-sm">
                  {item.icon}
                </div>
        ...
        <div className="bg-white dark:bg-slate-900 p-10 md:p-16 rounded-[3.5rem] flex flex-col md:flex-row items-center justify-between gap-12 relative overflow-hidden border border-slate-200 dark:border-slate-800">
          ...
          <div className="relative z-10 grid grid-cols-2 gap-4 w-full md:w-auto">
            <div className="p-6 bg-slate-50 dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-800 text-center">
            ...
            <div className="p-6 bg-slate-50 dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-800 text-center col-span-2">
              <div className="flex items-center justify-center gap-2 text-2xl font-black text-emerald-500 mb-1">
                <span className="text-2xl">💰</span> Monthly
              </div>
