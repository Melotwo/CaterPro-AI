...
const AiChatBot: React.FC = () => {
    ...
    const initializeChat = () => {
        try {
            ...
            chatRef.current = ai.chats.create({
              ...
              config: {
                systemInstruction: 'You are a friendly and professional AI Catering Consultant. Your primary role is to assist users with questions about event planning, menu proposals, food pairings, and catering logistics. Keep your answers concise, helpful, and encouraging. Do not generate full menu proposals, only answer questions about them.',
              },
            });
        } catch (e) {
    ...
    const handleSendMessage = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // FIX: The state setter function `setIsLoading` should be called, not the state variable `isLoading`.
            setIsLoading(false);
            inputRef.current?.focus();
        }
    };
