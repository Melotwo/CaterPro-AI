...
const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-dark bg-opacity-90">
              ...
              {showFounderLogin ? (
                ...
                isLogin ? (
                  ...
                  <span className="text-slate-900 dark:text-white">
                    Join <span className="font-bold">CaterPro</span><span className="font-medium text-emerald">Ai</span>
                  </span>
                )
              )}
            </h2>
