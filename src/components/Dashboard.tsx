    ...
    >
      ...
      <div className="bg-dark rounded-[3rem] p-8 shadow-[0_50px_100px_rgba(0,0,0,0.5)] border-2 border-emerald-500/50 relative overflow-hidden group">
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
            ...
            >
              ...
              <div className="mt-2 flex items-center gap-1 text-xs font-bold text-[#10b981] opacity-100">
                <span className="text-xs text-[#10b981]">📈</span> Optimized for Profit
              </div>
            </button>
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-xl bg-amber-500/20 flex items-center justify-center text-[#FFD700] group-hover/btn:bg-amber-500 group-hover/btn:text-white transition-colors">
              ...
              <div className="mt-2 flex items-center gap-1 text-xs font-bold text-[#FFD700] opacity-100">
                <span className="text-xs text-[#FFD700]">📊</span> Below Industry Avg
              </div>
            </button>
          </div>
            ...
            <div className="flex items-center justify-between p-6 rounded-2xl bg-[#1a1a1a] text-white border border-emerald-500/20">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <span className="text-xs text-[#10b981] font-bold uppercase tracking-widest opacity-100">Top Performer</span>
                </div>
              </div>
              <span className="text-2xl font-anchor text-[#10b981] opacity-100">R1,250</span>
            </div>
        ...
        <button 
          ...
          className="absolute -top-6 -right-6 w-36 h-36 bg-[#FFD700] rounded-full flex items-center justify-center border-8 border-dark shadow-2xl rotate-12 group-hover:rotate-0 transition-transform active:scale-95 cursor-pointer z-20"
        >
