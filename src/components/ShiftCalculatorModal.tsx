...
const ShiftCalculatorModal: React.FC<ShiftCalculatorModalProps> = ({
  isOpen,
  onClose,
  initialIngredients,
  menuTitle
      ...
      <div className="w-full max-w-6xl h-full max-h-[90vh] bg-dark-soft border-2 border-emerald-500/50 rounded-[3rem] shadow-2xl overflow-hidden flex flex-col relative">
        ...
        <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
          <div className="bg-dark rounded-[2rem] border border-white/10 overflow-hidden">
            ...
            >
              <span className="text-lg">➕</span> Add Custom Ingredient
            </button>
          </div>
        </div>

        {/* Footer */}
        <div className="p-8 bg-dark border-t border-white/10 flex items-center justify-between">
...
export default ShiftCalculatorModal;
