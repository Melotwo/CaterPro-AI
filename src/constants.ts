...
import { ChefHat, Check, ArrowRight, Star, Zap, Quote, ChevronDown, ChevronUp, HelpCircle, AlignLeft, Linkedin, Twitter, Brain, Heart, Gift } from 'lucide-react';
...
const LandingPage: React.FC<LandingPageProps> = ({ onGetStarted }) => {
  ...
  const handleShare = (platform: 'linkedin' | 'twitter') => {
      const url = "https://caterpro-ai.web.app/"; // Use the clean main URL
      const text = encodeURIComponent("I just launched CaterPro AI! It helps chefs write catering proposals and shopping lists automatically. I built this to solve the admin headaches I faced in the kitchen. Check it out:");
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 text-center lg:text-left z-10">
            <div className="flex flex-wrap justify-center lg:justify-start gap-2 mb-6">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-100 dark:bg-amber-900/30 text-amber-800 dark:text-amber-300 text-sm font-semibold animate-fade-in border border-amber-200 dark:border-amber-700">
