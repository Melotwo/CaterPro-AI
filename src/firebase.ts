...
// Import the config directly if it exists, otherwise use an empty object
// Vite handles JSON imports automatically
import jsonConfig from '../firebase-applet-config.json';

const firebaseConfig = {
  apiKey: jsonConfig.apiKey || (import.meta.env ? import.meta.env.VITE_FIREBASE_API_KEY : ''),
  authDomain: jsonConfig.authDomain || (import.meta.env ? import.meta.env.VITE_FIREBASE_AUTH_DOMAIN : ''),
  projectId: jsonConfig.projectId || (import.meta.env ? import.meta.env.VITE_FIREBASE_PROJECT_ID : ''),
  storageBucket: jsonConfig.storageBucket || (import.meta.env ? import.meta.env.VITE_FIREBASE_STORAGE_BUCKET : ''),
  messagingSenderId: jsonConfig.messagingSenderId || (import.meta.env ? import.meta.env.VITE_FIREBASE_MESSAGING_SENDER_ID : ''),
  appId: jsonConfig.appId || (import.meta.env ? import.meta.env.VITE_FIREBASE_APP_ID : ''),
  firestoreDatabaseId: jsonConfig.firestoreDatabaseId || (import.meta.env ? import.meta.env.VITE_FIREBASE_FIRESTORE_DATABASE_ID : ''),
};
